...
exports.seed = async function () {
    ...
    await knex('challenges').insert([
        ...
        },
        {
            ...
            description: "Cycle at least 20km and take a photo of your most scenic stop. Share your route!",
            img: null,
            is_contest: false,
            created_at: faker.date.recent(),
            end_time: null,
        ...
        },
        {
            ...
            description: "Capture a photo of a natural landscape taken during golden hour.",
            img: null,
            is_contest: true,
            created_at: faker.date.recent(),
            end_time: faker.date.soon(),
        ...
        },
        {
            ...
            description: "Write a story under 500 words using the phrase 'beneath the old bridge'.",
            img: null,
            is_contest: true,
            created_at: faker.date.recent(),
            end_time: faker.date.soon(),
        ...
        },
        {
            ...
            description: "Plant a new flower or vegetable and track growth over 2 weeks.",
            img: null,
            is_contest: false,
            created_at: faker.date.recent(),
            end_time: null,
        ...
        },
        {
            ...
            description: "Solve the classic 'Two Sum' problem and post your solution in JavaScript.",
            img: null,
            is_contest: true,
            created_at: faker.date.recent(),
            end_time: faker.date.soon(),
    ...
    const categoryChallengePairs = [
        ...
        { category_title: "Self-Expression", challenge_title: "Flash Fiction Frenzy" },
        { category_title: "Self-Expression", challenge_title: "Delicious Desserts" },
    ...
    const categoriesByTitle = Object.fromEntries(categoryMap.map(c => [c.title, c.id]));
    const challengesByTitle = Object.fromEntries(challengeMap.map(c => [c.title, c.id]));
